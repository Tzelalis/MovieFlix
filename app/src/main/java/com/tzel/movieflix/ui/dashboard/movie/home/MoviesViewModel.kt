package com.tzel.movieflix.ui.dashboard.movie.home
...
import com.tzel.movieflix.ui.dashboard.movie.home.model.MoviesUiCategory
    ...
    private fun loadPopularMovies() {
        ...
        popularMoviesJob = launch {
            val popular = MoviesUiCategory(
                name = TextBuilder.StringResource(R.string.movies_popular_title),
    ...
    private fun loadTrendingMovies() {
        ...
        trendingMoviesJob = launch {
            val trending = MoviesUiCategory(
                name = TextBuilder.StringResource(R.string.movies_trending_title),
                movies = Pager(PagingConfig(pageSize = PAGE_SIZE)) {
                    MoviesPagingSource(
                        movieToMovieUiMapper = moviesUiMapper,
    ...
    private fun loadWatchlistMovies() {
        ...
        watchlistMoviesJob = launch {
            val watchlist = MoviesUiCategory(
                name = TextBuilder.StringResource(R.string.movies_watchlist_title),
                movies = Pager(PagingConfig(pageSize = PAGE_SIZE)) {
                    MoviesPagingSource(
                        movieToMovieUiMapper = moviesUiMapper,
