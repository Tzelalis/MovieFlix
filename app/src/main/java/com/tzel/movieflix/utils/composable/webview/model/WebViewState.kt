...
class WebViewState(webContent: WebContent) {
    ...
    /**
     * Current request has connection error from main frame.
     * Connection errors: [AdvancedWebViewClient.ERR_INTERNET_DISCONNECTED] (-2), [AdvancedWebViewClient.ERR_INTERNET_ABORTED] (-6),
     * [AdvancedWebViewClient.ERR_CONNECTION_TIMED_OUT] (-8).
     * For more fine grained control use the OnError callback of the WebView.
     */
    var connectionErrorForCurrentRequest by mutableStateOf(false)
        internal set
